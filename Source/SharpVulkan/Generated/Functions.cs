...
namespace SharpVulkan
{
    ...
    public partial struct Device
    {
        ...
        public unsafe Result GetQueryPoolResults(QueryPool queryPool, uint firstQuery, uint queryCount, PointerSize dataSize, IntPtr data, ulong stride, QueryResultFlags flags)
        {
            Result __result__;
            __result__ = vkGetQueryPoolResults(this, queryPool, firstQuery, queryCount, dataSize, data, stride, flags);
            __result__.CheckError();
            return __result__;
        }
